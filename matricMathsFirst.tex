...
%
%
\includeonly{./tex/factorsAndMultiples,./tex/integers,./tex/rationalNumbers,./tex/estimationAndApproximation,./tex/inequalities,./tex/differentiation}%
...
\title{{ریاضیات اول}\small\\ { برائے نہم و دہم}}
...
\include{./tex/factorsAndMultiples}
\include{./tex/integers}
\include{./tex/estimationAndApproximation}
