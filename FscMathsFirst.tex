...
%
\includeonly{./tex/coordinatesPointsAndLines,./tex/surdsAndIndices,./tex/funtionsAndGraphs,./tex/quadratics,./tex/inequalities,./tex/differentiation,./tex/applicationsOfDifferentiation,./tex/sequences,./tex/theBinomialTheorem,./tex/trignometry,./tex/combiningAndInvertingFunctions,./tex/extendingDifferentiation,./tex/vectors,./tex/geometricSequences,./tex/secondDerivatives,./tex/integration,./tex/volumeOfRevolution,./tex/radians}%
%
%\includeonly{,./tex/volumeOfRevolution}%
...
\title{{ریاضیات اول}\small\\ {برائے گیاریوں اور بارویں جماعت}}
...
\include{./tex/coordinatesPointsAndLines}
\include{./tex/surdsAndIndices}
\include{./tex/funtionsAndGraphs}
\include{./tex/quadratics}
\include{./tex/inequalities}
\include{./tex/differentiation}
\include{./tex/applicationsOfDifferentiation}
\include{./tex/sequences}
\include{./tex/theBinomialTheorem}
\include{./tex/trignometry}
\include{./tex/combiningAndInvertingFunctions}
\include{./tex/extendingDifferentiation}
\include{./tex/vectors}
\include{./tex/geometricSequences}
\include{./tex/secondDerivatives}
\include{./tex/integration}
\include{./tex/volumeOfRevolution}
\include{./tex/radians}%
